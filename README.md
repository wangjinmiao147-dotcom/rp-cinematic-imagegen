...
- 手机快捷操作条：聊天页常驻“🎬 出图”和“⚙ 面板”，不依赖会被手机端折叠的消息操作按钮。
...
1. 下载 Release 中的 `rp-cinematic-imagegen-tavern-helper-installer-v2.9.14.json`。
...
1. 下载 Release 中的 `rp-cinematic-imagegen-v2.9.14.zip`。
...
- 手机端可直接点击聊天页右下方常驻的“🎬 出图”；“⚙ 面板”可切换镜头、画幅、画风和自动出图。
